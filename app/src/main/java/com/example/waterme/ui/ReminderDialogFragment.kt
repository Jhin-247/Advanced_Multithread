            ...
            val builder = AlertDialog.Builder(it)
                ...
                .setItems(R.array.water_schedule_array) { _, position ->
                    when (position) {
                        0 ->
                            viewModel
                                .scheduleReminder(5, TimeUnit.SECONDS, plantName, requireContext())
                        1 ->
                            viewModel
                                .scheduleReminder(1, TimeUnit.DAYS, plantName, requireContext())
                        2 ->
                            viewModel
                                .scheduleReminder(7, TimeUnit.DAYS, plantName, requireContext())
                        3 ->
                            viewModel
                                .scheduleReminder(30, TimeUnit.DAYS, plantName, requireContext())
                    }
                }
            builder.create()
